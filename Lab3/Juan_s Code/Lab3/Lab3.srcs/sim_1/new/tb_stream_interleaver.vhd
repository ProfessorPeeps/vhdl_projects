...
entity tb_stream_interleaver_pt1 is
--  Port ( );
end tb_stream_interleaver_pt1;

architecture Behavioral of tb_stream_interleaver_pt1 is

component stream_interleaver_pt1 is
...
UUT: stream_interleaver_pt1
port map(p0 => p0_reg, p1 => p1_reg, pf => pf_reg);
