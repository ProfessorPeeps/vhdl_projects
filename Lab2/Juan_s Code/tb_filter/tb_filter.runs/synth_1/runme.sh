...
HD_PWD='U:/ECE524L/Lab2/tb_filter/tb_filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cic.tcl
