...
HD_PWD='Z:/ECE/ECE524L/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log computeAverage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source computeAverage.tcl
